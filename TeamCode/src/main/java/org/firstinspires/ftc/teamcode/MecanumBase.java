...
public abstract class MecanumBase extends LinearOpMode {
    ...
    protected void initialize_pre_start(HardwareMap hardware_map) {
        mtr_rf = hardwareMap.dcMotor.get("motorTopRight");
        mtr_rr = hardwareMap.dcMotor.get("motorDownRight");
        mtr_lf = hardwareMap.dcMotor.get("motorTopLeft");
        mtr_lr = hardwareMap.dcMotor.get("motorDownLeft");
